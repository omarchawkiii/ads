...
function getStatusAction(status, id ) {
    switch (status) {
        ...
        case 2: return '<button  data-bs-toggle="tooltip" data-bs-placement="top"  data-bs-title="Reject" title="Reject"  id="'+id+'" type="button" class="reject  ustify-content-center btn mb-1 btn-rounded btn-danger  m-1"><i class="mdi mdi-close-octagon "></i></button>    <button  data-bs-toggle="tooltip" data-bs-placement="top"  data-bs-title="Generate Invoice" title="Generate Invoice"  id="' + id + '" type="button" class="billing justify-content-center btn mb-1 btn-rounded btn-primary m-1">' + '<i class="m mdi mdi-file-document"></i>' + '</button>  ';
        case 3: return ' ';
