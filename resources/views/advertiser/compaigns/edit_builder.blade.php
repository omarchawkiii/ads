                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" inputmode="decimal" class="form-control" id="budget" name="budget" placeholder="0.00" value="{{ $isEdit && $compaign->budget !== null ? number_format($compaign->budget, 2) : '' }}"/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                ...
                nocResults.forEach(function(r) {
                    ...
                    if (r.missing_cpls && r.missing_cpls.length > 0) {
                        ...
                        r.missing_cpls.forEach(function(m) {
                            html += '<li class="text-warning"><i class="mdi mdi-alert"></i> Missing CPL: <strong>' + m.cpl + '</strong> (slot: ' + m.slot + ')</li>';
                        });
                        html += '</ul>';
                    }
                    html += '</li>';
