...
@section('content')
            ...
            <div>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="genre" role="tabpanel">
                                  ...
                                  <nav aria-label="breadcrumb" class="ms-auto">
                                    <ol class="breadcrumb">
                                      <li class="breadcrumb-item" aria-current="page">
                                        <button class="btn bg-success  text-white " id="create_movie_genre">
                                            + New Movie Genres
                                        </button>
                                      </li>
                                    </ol>
                        ...
                        <div class="card">
                            <div class="card-body table-responsive">
                                <table id="movie_genres-table" class="table table-striped table-bordered display text-nowrap dataTable">
                                    <thead>
                    ...
                    <div class="tab-pane " id="interest" role="tabpanel">
                              ...
                              <div class="col-12">
                                <div class="d-sm-flex align-items-center justify-space-between">
                                  ...
                                  <nav aria-label="breadcrumb" class="ms-auto">
                                    <ol class="breadcrumb">
                                      <li class="breadcrumb-item" aria-current="page">
                                        <button class="btn bg-success  text-white " id="create_interest">
                                            + New Interest
                                        </button>
                                      </li>
                                    </ol>
                        ...
                        <div class="card">
                            <div class="card-body table-responsive">
                                <table id="interests-table" class="table table-striped table-bordered display text-nowrap dataTable">
                                    <thead>
                                        <tr class="text-center">
                                            <th class="text-center" style="width:160px;">ID</th>
                                            <th class="text-center">Name</th>
                    ...
                    <div class="tab-pane " id="targets" role="tabpanel">
                              ...
                              <div class="col-12">
                                <div class="d-sm-flex align-items-center justify-space-between">
                                  ...
                                  <nav aria-label="breadcrumb" class="ms-auto">
                                    <ol class="breadcrumb">
                                      <li class="breadcrumb-item" aria-current="page">
                                        <button class="btn bg-success  text-white " id="create_target">
                                            + New Target
                                        </button>
                                      </li>
                                    </ol>
                        ...
                        <div class="card">
                            <div class="card-body table-responsive">
                                <table id="targets-table" class="table table-striped table-bordered display text-nowrap dataTable">
                                    <thead>
                                        <tr class="text-center">
                                            <th class="text-center" style="width:160px;">ID</th>
                                            <th class="text-center">Name</th>
    ...
    {{-- Target Modal --}}
        <div class="modal  " id="create_target_modal" tabindex="-1" aria-labelledby="bs-example-modal-lg" aria-modal="true" role="dialog">
            <div class="modal-dialog modal-md  modal-dialog-centered">
                <div class="modal-content">
                    <form method="post" id="create_target_form">
        ...
        <div class="modal " id="edit_target_modal" tabindex="-1" aria-labelledby="bs-example-modal-lg" aria-modal="true" role="dialog">
            <div class="modal-dialog modal-md modal-dialog-centered">
                <div class="modal-content">
                    <form method="post" id="edit_target_form">
                        <div class="modal-header d-flex align-items-center  bg-primary ">
                            <h4 class="modal-title text-white " id="myLargeModalLabel ">
                                Edit Target Type
                            </h4>
    ...
    {{-- End Interest Modal --}}
        <div class="modal  " id="create_interest_modal" tabindex="-1" aria-labelledby="bs-example-modal-lg" aria-modal="true" role="dialog">
            <div class="modal-dialog modal-md  modal-dialog-centered">
                <div class="modal-content">
                    <form method="post" id="create_interest_form">
                        <div class="modal-header d-flex align-items-center  bg-primary ">
                            <h4 class="modal-title text-white " id="myLargeModalLabel ">
                                Create Interest
                            </h4>
        ...
        <div class="modal " id="edit_interest_modal" tabindex="-1" aria-labelledby="bs-example-modal-lg" aria-modal="true" role="dialog">
            <div class="modal-dialog modal-md modal-dialog-centered">
                <div class="modal-content">
                    <form method="post" id="edit_interest_form">
                        <div class="modal-header d-flex align-items-center  bg-primary ">
                            <h4 class="modal-title text-white " id="myLargeModalLabel ">
                                Edit Interest
                            </h4>
    ...
    {{--  Movie Genre Modal --}}
        <div class="modal  " id="create_movie_genre_modal" tabindex="-1" aria-labelledby="bs-example-modal-lg" aria-modal="true" role="dialog">
            <div class="modal-dialog modal-md  modal-dialog-centered">
                <div class="modal-content">
                    <form method="post" id="create_movie_genre_form">
                        <div class="modal-header d-flex align-items-center  bg-primary ">
                            <h4 class="modal-title text-white " id="myLargeModalLabel ">
                                Create Movie Genres
                            </h4>
        ...
        <div class="modal " id="edit_movie_genre_modal" tabindex="-1" aria-labelledby="bs-example-modal-lg" aria-modal="true" role="dialog">
            <div class="modal-dialog modal-md modal-dialog-centered">
                <div class="modal-content">
                    <form method="post" id="edit_movie_genre_form">
                        <div class="modal-header d-flex align-items-center  bg-primary ">
                            <h4 class="modal-title text-white " id="myLargeModalLabel ">
                                Edit Movie Genres
                            </h4>
...
@section('custom_script')
        ...
        <script>
            ...
            $(function() {
                $(document).on('click', '#create_target', function() {
                    $('#create_target_modal').modal('show');
                })
                function get_targets() {
                    $('#wait-modal').modal('show');

                    $("#targets-table").dataTable().fnDestroy();
                    var url = "{{ url('') }}" + '/targets/list';
                    var result = " ";
                    $.ajax({
                            url: url,
                            method: 'GET',
                            ...
                            success: function(response) {
                                $.each(response.targets, function(index, value) {
                                    var user_targets = "";
                                    index++;
                                    result = result +
                                ...
                                $('#targets-table tbody').html(result)
                                $('#wait-modal').modal('hide');
                                // $('#loader-modal').css('display','none')
                                /***** refresh datatable **** **/

                                var targets = $('#targets-table').DataTable({
                                    "iDisplayLength": 10,
                                    destroy: true,
                                    "bDestroy": true,
                                    "language": {
                ...
                $(document).on("submit", "#create_target_modal", function(event) {

                    event.preventDefault();
                    var name = $('#create_target_modal #name ').val();
                    var detail = $('#create_target_modal #detail ').val();
                    var cpm = $('#create_target_modal #cpm').val();
                    ...
                    $.ajax({
                        ...
                        .done(function(response) {
                            ...
                            Swal.fire({
                                title: 'Done!',
                                text: 'Target Type Created successfully.',
                                icon: 'success',
                                confirmButtonText: 'Continue'
                            });
                            reset_form('#create_target_modal form')
                        })
                        .fail(function(xhr) {
                            Swal.fire({
                                title: 'Error',
                        ...
                        .always(function() {
                            $('#wait-modal').modal('hide');
                            $('#create_target_modal').modal('hide');
                        });

                })

                $(document).on('click', '#targets .delete', function() {
                    var id = $(this).attr('id');
                    console.log(id)

                    const url = '{{ url('') }}' + '/targets/' + encodeURIComponent(id);
                    ...
                    Swal.fire({
                        ...
                        $.ajax({
                            ...
                            .done(function(response) {
                                ...
                                Swal.fire({
                                    title: 'Done!',
                                    text: 'Target Type deleted successfully.',
                                    icon: 'success',
                                    confirmButtonText: 'Continue'
                                });
                ...
                $(document).on('click', '#targets .edit', function() {
                    var target = $(this).attr('id');
                    var url = '{{ url('') }}' + '/targets/' + target+ '/show/';
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $('#edit_target_modal #name').val(response.target.name)
                            $('#edit_target_modal #detail').val(response.target.detail)
                            $('#edit_target_modal #cpm').val(response.target.cpm)
                            $('#edit_target_modal #id').val(target)
                ...
                $(document).on("submit","#edit_target_form" , function(event) {
                    event.preventDefault();
                    var name = $('#edit_target_form #name').val();
                    var cpm = $('#edit_target_form #cpm').val();
                    var detail = $('#edit_target_form #detail').val();
                    var id = $('#edit_target_form #id').val();
                    var url = '{{ url('') }}' + '/targets/'+ id;
                    ...
                    .done(function(response) {
                        ...
                        get_targets()
                            swal.fire({
                                title: 'Done!',
                                text: 'Target Type Updated Successfully ',
                                icon: 'success',
                                button: {
                                    text: "Continue",
                                    value: true,
    ...
    {{-- Objective Script --}}
        <script>
            ...
            $(function() {
                ...
                $(document).on('click', '#objective .edit', function() {
    ...
    {{-- End Objective Script --}}

    {{-- Interest Script --}}
        <script>

            $(function() {
                $(document).on('click', '#create_interest', function() {
                    $('#create_interest_modal').modal('show');
                })
                function get_interests() {
                    $('#wait-modal').modal('show');

                    $("#interests-table").dataTable().fnDestroy();
                    var url = "{{ url('') }}" + '/interests/list';
                    var result = " ";
                    $.ajax({
                            url: url,
                            method: 'GET',
                            ...
                            success: function(response) {
                                ...
                                $('#interests-table tbody').html(result)
                                $('#wait-modal').modal('hide');
                                // $('#loader-modal').css('display','none')
                                /***** refresh datatable **** **/

                                var interests = $('#interests-table').DataTable({
                                    "iDisplayLength": 10,
                                    destroy: true,
                                    "bDestroy": true,
                                    "language": {
                ...
                $(document).on("submit", "#create_interest_modal", function(event) {

                    event.preventDefault();
                    var name = $('#create_interest_modal #name ').val();

                    var url = '{{ url('') }}' + '/interests';
                    ...
                    $.ajax({
                        ...
                        .done(function(response) {
                            ...
                            reset_form('#create_interest_modal form')
                        })
                        .fail(function(xhr) {
                            Swal.fire({
                                title: 'Error',
                        ...
                        .always(function() {
                            $('#wait-modal').modal('hide');
                            $('#create_interest_modal').modal('hide');
                        });

                })

                $(document).on('click', '#interest .delete', function() {
                    var id = $(this).attr('id');
                    console.log(id)

                    const url = '{{ url('') }}' + '/interests/' + encodeURIComponent(id);
                    const csrf = '{{ csrf_token() }}';
                    console.log(url)
                    // SweetAlert2 confirm
                    Swal.fire({
                ...
                $(document).on('click', '#interest .edit', function() {
                    var interest = $(this).attr('id');
                    var url = '{{ url('') }}' + '/interests/' + interest+ '/show/';
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $("#wait-modal").modal('hide');
                            $('#edit_interest_modal').modal('show');
                            $('#edit_interest_modal #name').val(response.interest.name)
                            $('#edit_interest_modal #id').val(interest)
                ...
                $(document).on("submit","#edit_interest_form" , function(event) {
                    event.preventDefault();
                    var name = $('#edit_interest_form #name').val();
                    var id = $('#edit_interest_form #id').val();
                    var url = '{{ url('') }}' + '/interests/'+ id;
                    ...
                    .done(function(response) {
                        ...
                        $("#wait-modal").modal('hide');
                        $('#edit_interest_modal').modal('hide');
                        get_interests()
                            swal.fire({
                                title: 'Done!',
    ...
    {{-- Movie Genre Script --}}
        <script>
            ...
            $(function() {
                $(document).on('click', '#create_movie_genre', function() {
                    $('#create_movie_genre_modal').modal('show');
                })
                function get_movie_genres() {
                    $('#wait-modal').modal('show');

                    $("#movie_genres-table").dataTable().fnDestroy();
                    var url = "{{ url('') }}" + '/movies_genres/list';
                    var result = " ";
                    $.ajax({
                            url: url,
                            method: 'GET',
                            ...
                            contentType: false,
                            success: function(response) {
                                $.each(response.movie_genres, function(index, value) {
                                    index++;
                                    result = result +
                                        '<tr class="odd text-center">' +
                                        '<td class="text-body align-middle fw-medium text-decoration-none">' +
                                ...
                                $('#movie_genres-table tbody').html(result)
                                $('#wait-modal').modal('hide');
                                // $('#loader-modal').css('display','none')
                                /***** refresh datatable **** **/

                                var movie_genres = $('#movie_genres-table').DataTable({
                                    "iDisplayLength": 10,
                                    destroy: true,
                                    "bDestroy": true,
                                    "language": {
                ...
                $(document).on("submit", "#create_movie_genre_modal", function(event) {

                    event.preventDefault();
                    var name = $('#create_movie_genre_modal #name ').val();

                    var url = '{{ url('') }}' + '/movies_genres';
                    ...
                    $.ajax({
                        ...
                        .done(function(response) {
                            ...
                            Swal.fire({
                                title: 'Done!',
                                text: 'Movie Genre Created successfully.',
                                icon: 'success',
                                confirmButtonText: 'Continue'
                            });
                            reset_form('#create_movie_genre_modal form')
                        })
                        .fail(function(xhr) {
                            Swal.fire({
                                title: 'Error',
                        ...
                        .always(function() {
                            $('#wait-modal').modal('hide');
                            $('#create_movie_genre_modal').modal('hide');
                        });
                ...
                $(document).on('click', '#genre .delete', function() {
                    ...
                    const url = '{{ url('') }}' + '/movies_genres/' + encodeURIComponent(id);
                    const csrf = '{{ csrf_token() }}';
                    console.log(url)
                    // SweetAlert2 confirm
                    Swal.fire({
                        title: 'Delete Movie Genre?',
                        text: 'Are you sure you want to delete this Movie Genre?',
                        icon: 'warning',
                        showCancelButton: true,
                        confirmButtonText: 'Yes, delete it',
                        cancelButtonText: 'Cancel'
                        ...
                        $.ajax({
                            ...
                            .done(function(response) {
                                ...
                                Swal.fire({
                                    title: 'Done!',
                                    text: 'Movie Genre deleted successfully.',
                                    icon: 'success',
                                    confirmButtonText: 'Continue'
                                });
                ...
                $(document).on('click', '#genre .edit', function() {
                    var movie_genre = $(this).attr('id');
                    var url = '{{ url('') }}' + '/movies_genres/' + movie_genre+ '/show/';
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $("#wait-modal").modal('hide');
                            $('#edit_movie_genre_modal').modal('show');
                            $('#edit_movie_genre_modal #name').val(response.movie_genre.name)
                            $('#edit_movie_genre_modal #id').val(movie_genre)
                ...
                $(document).on("submit","#edit_movie_genre_form" , function(event) {
                    event.preventDefault();
                    var name = $('#edit_movie_genre_form #name').val();
                    var id = $('#edit_movie_genre_form #id').val();
                    var url = '{{ url('') }}' + '/movies_genres/'+ id;
                    ...
                    .done(function(response) {
                        ...
                        $("#wait-modal").modal('hide');
                        $('#edit_movie_genre_modal').modal('hide');
                        get_movie_genres()
                            swal.fire({
                                title: 'Done!',
                                text: 'Movie Genre Updated Successfully ',
                                icon: 'success',
                                button: {
                                    text: "Continue",
                                    value: true,
